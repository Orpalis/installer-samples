...
namespace DocuViewareSharePointAdd_inWeb
{
    ...
    public class SharePointHighTrustContext : SharePointContext
    {
        ...
        public SharePointHighTrustContext(Uri spHostUrl, Uri spAppWebUrl, string spLanguage, string spClientTag, string spProductNumber, WindowsIdentity logonUserIdentity)
            : base(spHostUrl, spAppWebUrl, spLanguage, spClientTag, spProductNumber)
        {
            this.logonUserIdentity = logonUserIdentity ?? throw new ArgumentNullException("logonUserIdentity");
        }
    ...
    public class SharePointHighTrustContextProvider : SharePointContextProvider
    {
        ...
        {
#if IMPERSONATE
            using (SharepointUser spUser = new SharepointUser())
            {
                WindowsIdentity logonUserIdentity = spUser.User;
...
#else
            return new SharePointHighTrustContext(spHostUrl, spAppWebUrl, spLanguage, spClientTag, spProductNumber, httpRequest.LogonUserIdentity);
#endif
        }
    ...
    public class SharepointUser : IDisposable
    {
        ...
        public WindowsIdentity User { get; set; }
        private SafeTokenHandle handle { get; set; }
        private void GetUser()
        {
            ...
            bool returnValue = LogonUser("sharepoint_demo", "SHAREPOINT", "Sharepoint2019", LOGON32_LOGON_INTERACTIVE, LOGON32_PROVIDER_DEFAULT, out SafeTokenHandle safeTokenHandle);
