...
namespace Csharp_Pages_Manipulation.WPF
{
    public static class CustomCommands
    {
        ...
        public static readonly RoutedUICommand DeleteSelectedPage = new RoutedUICommand
                (
                        "DeleteSelectedPage",
                        "DeleteSelectedPage",
                        typeof(CustomCommands),
        ...
        #region "Text Custom Commands"
         public static readonly RoutedUICommand PageText = new RoutedUICommand
                 (
                         "PageText",
                         "PageText",
                         typeof(CustomCommands),
         ...
         public static readonly RoutedUICommand AreaText = new RoutedUICommand
                  (
                          "AreaText",
                          "AreaText",
                          typeof(CustomCommands),
