namespace DocumentCleanUp
{
	...
	partial class frmSave : System.Windows.Forms.Form
	{
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
            ...
            this.nPngCompressionLevel.Maximum = new decimal(new int[] {
            9,
            0,
            0,
            0});
            this.nPngCompressionLevel.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.nPngCompressionLevel.Value = new decimal(new int[] {
            6,
            0,
            0,
            0});
            ...
            this.nJpegQuality.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.nJpegQuality.Value = new decimal(new int[] {
            75,
            0,
            0,
            0});
            ...
            this.nJ2kRate.Maximum = new decimal(new int[] {
            512,
            0,
            0,
            0});
            this.nJ2kRate.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.nJ2kRate.Value = new decimal(new int[] {
            16,
            0,
            0,
            0});
